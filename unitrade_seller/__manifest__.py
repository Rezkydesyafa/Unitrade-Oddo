{
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'unitrade_seller/static/src/xml/seller_refunds_owl.xml',
            'unitrade_seller/static/src/xml/seller_payouts_owl.xml',
            'unitrade_seller/static/src/xml/seller_order_detail_owl.xml',
            'unitrade_seller/static/src/xml/seller_refund_detail_owl.xml',
            'unitrade_seller/static/src/xml/seller_products_owl.xml',
            'unitrade_seller/static/src/xml/seller_product_detail_owl.xml',
            ...
            'unitrade_seller/static/src/js/seller_refunds.js',
            'unitrade_seller/static/src/js/seller_payouts.js',
            'unitrade_seller/static/src/js/seller_order_detail.js',
            'unitrade_seller/static/src/js/seller_refund_detail.js',
            'unitrade_seller/static/src/js/seller_products.js',
            'unitrade_seller/static/src/js/seller_product_detail.js',
